...
data:
  ...
  bundledCode: "#line 1 \"tools/sparse_fps_pow.hpp\"\n\n\n\n#include <cstddef>\n#include\
    ...
    }\n\n\n#line 14 \"tools/sparse_fps_pow.hpp\"\n\nnamespace tools {\n  template\
    ...
    \ n - offset->first * k; ++i) {\n      for (auto it = ::std::next(offset); it\
    \ != end; ++it) {\n        if (i < deg(it)) break;\n        res[i] += (M(k) *\
    \ M(deg(it)) - M(i - deg(it))) * it->second * res[i - deg(it)];\n      }\n   \
    \   res[i] /= M(i) * offset->second;\n    }\n\n    res.insert(res.begin(), offset->first\
    \ * k, M::raw(0));\n    return res;\n  }\n}\n\n\n"
  ...
  requiredBy: []
  timestamp: '2023-01-02 17:19:26+09:00'
