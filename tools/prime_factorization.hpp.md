...
data:
  ...
  code: "#ifndef TOOLS_PRIME_FACTORIZATION_HPP\n#define TOOLS_PRIME_FACTORIZATION_HPP\n\
    ...
    \   * License: CC0\n   * @author anqooqie\n   * @param <T> type of n\n   * @param\
    \ <OutputIterator> type of result\n   * @param n input\n   * @param result output\
    \ iterator as a storage of ordered prime factors\n   */\n  template <typename\
...
layout: document
redirect_from:
- /library/tools/prime_factorization.hpp
- /library/tools/prime_factorization.hpp.html
