...
data:
  ...
  bundledCode: "#line 1 \"tools/floor_kth_root.hpp\"\n\n\n\n#include <cassert>\n#line\
    ...
    \ {\n          ok = mid;\n        } else {\n          ng = mid;\n        }\n \
    \     }\n      return ok;\n    }\n\n    T ok = 0;\n    T ng;\n    for (ng = 1;\
    \ ::tools::pow(::tools::safe_int<T>(ng), k) <= ::tools::safe_int<T>(x); ng *=\
    \ 2);\n\n    while (ng - ok > 1) {\n      const T mid = ok + (ng - ok) / 2;\n\
    \      if (::tools::pow(::tools::safe_int<T>(mid), k) <= ::tools::safe_int<T>(x))\
    \ {\n        ok = mid;\n      } else {\n        ng = mid;\n      }\n    }\n\n\
    \    return ok;\n  }\n}\n\n\n"
  code: "#ifndef TOOLS_FLOOR_KTH_ROOT_HPP\n#define TOOLS_FLOOR_KTH_ROOT_HPP\n\n#include\
    ...
    \ (ng - ok) / 2;\n        if (mid * mid <= x / mid) {\n          ok = mid;\n \
    \       } else {\n          ng = mid;\n        }\n      }\n      return ok;\n\
    \    }\n\n    T ok = 0;\n    T ng;\n    for (ng = 1; ::tools::pow(::tools::safe_int<T>(ng),\
    \ k) <= ::tools::safe_int<T>(x); ng *= 2);\n\n    while (ng - ok > 1) {\n    \
    \  const T mid = ok + (ng - ok) / 2;\n      if (::tools::pow(::tools::safe_int<T>(mid),\
    \ k) <= ::tools::safe_int<T>(x)) {\n        ok = mid;\n      } else {\n      \
    \  ng = mid;\n      }\n    }\n\n    return ok;\n  }\n}\n\n#endif\n"
  dependsOn:
