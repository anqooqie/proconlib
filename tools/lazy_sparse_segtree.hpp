...
namespace tools {
  ...
  class lazy_sparse_segtree {
    ...
    template <typename T>
    static constexpr bool has_data = !::std::is_same_v<T, ::tools::detail::lazy_sparse_segtree::nop_monoid>;
    template <typename T>
    static constexpr bool has_lazy = !::std::is_same_v<T, ::tools::detail::lazy_sparse_segtree::nop_monoid>;
