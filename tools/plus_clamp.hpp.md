...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 1 \"tools/plus_clamp.hpp\"\n\n\n\n#include <limits>\n#include\
    \ <algorithm>\n\nnamespace tools {\n\n  template <typename T>\n  constexpr T plus_clamp(const\
  ...
  code: "#ifndef TOOLS_PLUS_CLAMP_HPP\n#define TOOLS_PLUS_CLAMP_HPP\n\n#include <limits>\n\
    #include <algorithm>\n\nnamespace tools {\n\n  template <typename T>\n  constexpr\
    \ T plus_clamp(const T& lhs, const T& rhs, const T& min = ::std::numeric_limits<T>::min(),\
