...
data:
  ...
  code: "#ifndef TOOLS_TOTIENT_HPP\n#define TOOLS_TOTIENT_HPP\n\n#include <vector>\n\
    ...
    \ prime_factors.size(); l = r) {\n      for (; r < prime_factors.size() && prime_factors[l]\
    \ == prime_factors[r]; ++r);\n      prod *= ::tools::pow(prime_factors[l], r -\
    \ l - 1) * (prime_factors[l] - 1);\n    }\n    return prod;\n  }\n}\n\n#endif\n"
  dependsOn:
...
layout: document
redirect_from:
- /library/tools/totient.hpp
- /library/tools/totient.hpp.html
