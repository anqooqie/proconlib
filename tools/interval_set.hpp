...
namespace tools {
  ...
  public:
    ...
    ~interval_set() = default;
    ::tools::interval_set<T, Mergeable>& operator=(const ::tools::interval_set<T, Mergeable>&) = default;
    ::tools::interval_set<T, Mergeable>& operator=(::tools::interval_set<T, Mergeable>&&) = default;
    ...
    void erase(const T& l, const T& r) {
      ...
      const auto l_new_interval = l_it != this->m_intervals.end() && l_it->first < l
        ? ::std::make_optional(::std::make_pair(l_it->first, l - 1))
        : ::std::nullopt;
    ...
    friend ::std::ostream& operator<<(::std::ostream& os, const ::tools::interval_set<T, Mergeable>& self) {
      os << '{';
