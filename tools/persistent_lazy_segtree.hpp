...
namespace tools {
  ...
  public:
    ...
    S prod(long long l, long long r) const {
      ...
      return [&](this const auto& dfs, const int k, const long long kl, const long long kr, const F& lz) -> S {
        assert(kl < kr);
    ...
    long long max_right(long long l, const G& g) const {
      ...
      return buffer.m_offset + std::min([&](this const auto& dfs, const S& c, const int k, const long long kl, const long long kr, const F& lz) -> std::pair<S, long long> {
        assert(kl < kr);
        if (kl < l) {
          assert(kl < l && l < kr);
          const auto km = std::midpoint(kl, kr);
    ...
    long long min_left(long long r, const G& g) const {
      ...
      return buffer.m_offset + [&](this const auto& dfs, const S& c, const int k, const long long kl, const long long kr, const F& lz) -> std::pair<S, long long> {
        assert(kl < kr);
        if (r < kr) {
          assert(kl < r && r < kr);
          const auto km = std::midpoint(kl, kr);
