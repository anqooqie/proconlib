...
data:
  ...
  bundledCode: "#line 1 \"tools/nth_term.hpp\"\n\n\n\n#include <cstdint>\n#include\
    ...
    \ a_begin, InputIterator a_end, InputIterator c_begin, InputIterator c_end, ::std::uint_fast64_t\
    \ n) -> ::std::decay_t<decltype(*a_begin)> {\n    using M = ::std::decay_t<decltype(*a_begin)>;\n\
  ...
  code: "#ifndef TOOLS_NTH_TERM_HPP\n#define TOOLS_NTH_TERM_HPP\n\n#include <cstdint>\n\
    ...
    \ InputIterator c_begin, InputIterator c_end, ::std::uint_fast64_t n) -> ::std::decay_t<decltype(*a_begin)>\
