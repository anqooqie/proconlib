...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 1 \"tools/nth_term.hpp\"\n\n\n\n#include <type_traits>\n#include\
    ...
    \ InputIterator>\n  auto nth_term(InputIterator a_begin, InputIterator a_end,\
    \ InputIterator c_begin, InputIterator c_end, unsigned long long n) -> ::std::decay_t<decltype(*a_begin)>\
    \ {\n    using M = ::std::decay_t<decltype(*a_begin)>;\n    ::std::vector<M> G(a_begin,\
    \ a_end);\n    ::std::vector<M> Q(c_begin, c_end);\n    assert(G.size() + 1 ==\
    \ Q.size());\n    assert(Q[0] == M(1));\n\n    const auto d = G.size();\n    if\
    \ (d == 0) return M(0);\n\n    ::std::vector<M> P;\n    ::tools::convolution(G.begin(),\
    \ G.end(), Q.begin(), Q.end(), ::std::back_inserter(P));\n    P.resize(d);\n\n\
    ...
    \        Q.push_back(QQ[i]);\n      }\n      n /= 2;\n    }\n\n    return P[0];\n\
    \  }\n}\n\n\n"
  code: "#ifndef TOOLS_NTH_TERM_HPP\n#define TOOLS_NTH_TERM_HPP\n\n#include <type_traits>\n\
    #include <vector>\n#include <cassert>\n#include <iterator>\n#include \"tools/convolution.hpp\"\
    \n\nnamespace tools {\n  template <typename InputIterator>\n  auto nth_term(InputIterator\
    \ a_begin, InputIterator a_end, InputIterator c_begin, InputIterator c_end, unsigned\
    \ long long n) -> ::std::decay_t<decltype(*a_begin)> {\n    using M = ::std::decay_t<decltype(*a_begin)>;\n\
