...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 1 \"tools/detail/element_2d.hpp\"\n\n\n\n#include <type_traits>\n\
    #include <cstddef>\n#include <vector>\n#include <optional>\n#include <variant>\n\
    ...
    \ * p1.x - (p2.x - p1.x) * p1.y);\n  }\n}\n\n\n"
  code: "#ifndef TOOLS_DETAIL_ELEMENT_2D_HPP\n#define TOOLS_DETAIL_ELEMENT_2D_HPP\n\
    \n#include <type_traits>\n#include <cstddef>\n#include <vector>\n#include <optional>\n\
...
documentation_of: tools/detail/element_2d.hpp
layout: document
redirect_from:
- /library/tools/detail/element_2d.hpp
- /library/tools/detail/element_2d.hpp.html
