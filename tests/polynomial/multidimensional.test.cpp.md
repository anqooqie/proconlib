...
data:
  ...
  bundledCode: "#line 1 \"tests/polynomial/multidimensional.test.cpp\"\n#define PROBLEM\
    \ \"https://onlinejudge.u-aizu.ac.jp/problems/ITP1_1_A\"\n\n#include <iostream>\n\
    ...
    \      b.reserve(n);\n      for (int i = 0; i < n; ++i) {\n        b.push_back(pow_c[n\
    \ - 1 - i] * cache.fact_inv(n - 1 - i));\n      }\n\n      a *= b;\n\n      this->clear();\n\
    \      this->reserve(n);\n      for (int i = 0; i < ::std::min(n, int(a.size())\
    \ - (n - 1)); ++i) {\n        this->push_back(a[n - 1 + i] * cache.fact_inv(i));\n\
    \      }\n      return *this;\n    }\n    P& composition_ax_d(const R& a, const\
    \ int d) {\n      assert(d >= 0);\n\n      this->regularize();\n      if (this->empty())\
    \ return *this;\n\n      if (a == AG::e()) {\n        this->resize(1);\n     \
    ...
    \        auto g_i = P{MM::e()};\n        auto res = g_i;\n        for (int i =\
    \ 1; i < n; ++i) {\n          g_i *= g;\n          res += g_i;\n        }\n  \
    \      return res;\n      };\n\n      if constexpr (::tools::has_mod_v<R> && ::std::is_same_v<AG,\
    \ ::tools::group::plus<R>> && ::std::is_same_v<MM, ::tools::group::multiplies<R>>)\
    \ {\n        if (::tools::is_prime(R::mod()) && n < R::mod()) {\n          if\
    \ (m == 2) {\n            return P(this->begin(), this->begin() + n).taylor_shift(g[0]).composition_ax_d(g[1],\
    ...
    \ friend P operator>>(const P& f, const int d) { return P(f) >>= d; }\n  };\n\
    }\n\n\n#line 6 \"tests/polynomial/multidimensional.test.cpp\"\n\nusing ll = long\
    \ long;\nstruct AG {\n  using T = tools::polynomial<ll>;\n  static T op(const\
    \ T& x, const T& y) {\n    return x + y;\n  }\n  static T e() {\n    return T{};\n\
    \  }\n  static T inv(const T& x) {\n    return -x;\n  }\n};\nstruct MM {\n  using\
    \ T = tools::polynomial<ll>;\n  static T op(const T& x, const T& y) {\n    return\
    \ x * y;\n  }\n  static T e() {\n    return T{1};\n  }\n};\n\nint main() {\n \
    \ std::cin.tie(nullptr);\n  std::ios_base::sync_with_stdio(false);\n\n  tools::polynomial<AG,\
    \ MM> a{{1, 2}, {3, 4}};\n  tools::polynomial<AG, MM> b{{5, 6}, {7, 8}};\n  tools::polynomial<AG,\
    \ MM> c{{5, 16, 12}, {22, 60, 40}, {21, 52, 32}};\n\n  assert_that(a * b == c);\n\
  ...
  code: "#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/problems/ITP1_1_A\"\n\n\
    ...
    \ const T& y) {\n    return x * y;\n  }\n  static T e() {\n    return T{1};\n\
    \  }\n};\n\nint main() {\n  std::cin.tie(nullptr);\n  std::ios_base::sync_with_stdio(false);\n\
    \n  tools::polynomial<AG, MM> a{{1, 2}, {3, 4}};\n  tools::polynomial<AG, MM>\
    \ b{{5, 6}, {7, 8}};\n  tools::polynomial<AG, MM> c{{5, 16, 12}, {22, 60, 40},\
    \ {21, 52, 32}};\n\n  assert_that(a * b == c);\n\n  std::cout << \"Hello World\"\
    \ << '\\n';\n  return 0;\n}\n"
  dependsOn:
  ...
  verifiedWith: []
documentation_of: tests/polynomial/multidimensional.test.cpp
layout: document
redirect_from:
- /verify/tests/polynomial/multidimensional.test.cpp
- /verify/tests/polynomial/multidimensional.test.cpp.html
