...
data:
  ...
  bundledCode: "#line 1 \"tests/weighted_bipartite_matching.test.cpp\"\n#define PROBLEM\
    \ \"https://judge.yosupo.jp/problem/assignment\"\n\n#include <cstdint>\n#include\
    ...
    \  }\n}\n\n\n#line 9 \"tests/weighted_bipartite_matching.test.cpp\"\n\nusing i64\
  ...
  verifiedWith: []
documentation_of: tests/weighted_bipartite_matching.test.cpp
layout: document
redirect_from:
- /verify/tests/weighted_bipartite_matching.test.cpp
- /verify/tests/weighted_bipartite_matching.test.cpp.html
