...
data:
  ...
  bundledCode: "#line 1 \"tests/avl_tree/main_features.test.cpp\"\n#define PROBLEM\
    \ \"https://judge.yosupo.jp/problem/dynamic_sequence_range_affine_range_sum\"\n\
    ...
    \n\n#line 8 \"tests/avl_tree/main_features.test.cpp\"\n\nusing mint = atcoder::modint998244353;\n\
  ...
  verifiedWith: []
documentation_of: tests/avl_tree/main_features.test.cpp
layout: document
redirect_from:
- /verify/tests/avl_tree/main_features.test.cpp
- /verify/tests/avl_tree/main_features.test.cpp.html
