...
data:
  ...
  bundledCode: "#line 1 \"tests/lis/segtree/restore.test.cpp\"\n#define PROBLEM \"\
    https://judge.yosupo.jp/problem/longest_increasing_subsequence\"\n\n#include <iostream>\n\
    ...
    \  }\n}\n\n\n#line 7 \"tests/lis/segtree/restore.test.cpp\"\n\nint main() {\n\
  ...
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/longest_increasing_subsequence\"\
    ...
    \ \"tools/join.hpp\"\n\nint main() {\n  std::cin.tie(nullptr);\n  std::ios_base::sync_with_stdio(false);\n\
    \n  int N;\n  std::cin >> N;\n  std::vector<int> A(N);\n  for (auto&& A_i : A)\
    \ std::cin >> A_i;\n\n  const auto lis = tools::lis::segtree<true, true>(A.begin(),\
    \ A.end());\n  std::cout << lis.size() << '\\n';\n  std::cout << tools::join(lis.begin(),\
    \ lis.end(), \" \") << '\\n';\n\n  return 0;\n}\n"
  dependsOn:
  - tools/lis.hpp
...
layout: document
redirect_from:
- /verify/tests/lis/segtree/restore.test.cpp
- /verify/tests/lis/segtree/restore.test.cpp.html
