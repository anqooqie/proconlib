...
data:
  ...
  bundledCode: "#line 1 \"tests/lis/bisect/restore.test.cpp\"\n#define PROBLEM \"\
    https://judge.yosupo.jp/problem/longest_increasing_subsequence\"\n\n#include <iostream>\n\
  ...
  verifiedWith: []
documentation_of: tests/lis/bisect/restore.test.cpp
layout: document
redirect_from:
- /verify/tests/lis/bisect/restore.test.cpp
- /verify/tests/lis/bisect/restore.test.cpp.html
