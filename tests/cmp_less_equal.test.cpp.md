...
data:
  ...
  bundledCode: "#line 1 \"tests/cmp_less_equal.test.cpp\"\n#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/problems/ITP1_1_A\"\
    ...
    \n#line 6 \"tests/cmp_less_equal.test.cpp\"\n\nint main() {\n  std::cin.tie(nullptr);\n\
    \  std::ios_base::sync_with_stdio(false);\n\n  assert_that(tools::cmp_less_equal(-1,\
    \ 0U));\n  assert_that(tools::cmp_less_equal(0U, 0U));\n  assert_that(!tools::cmp_less_equal(0U,\
  ...
  verifiedWith: []
documentation_of: tests/cmp_less_equal.test.cpp
layout: document
redirect_from:
- /verify/tests/cmp_less_equal.test.cpp
- /verify/tests/cmp_less_equal.test.cpp.html
