...
int main() {
...

  {
    ...
    {
      assert_that(sieve.divisor_counts() == std::vector<int>{0, 1, 2, 2, 3, 2, 4, 2, 4, 3, 4});
    }
  }
  {
    ...
    {
      assert_that(sieve.divisor_counts() == std::vector<int>{0, 1});
    }
  }
  {
    ...
    {
      assert_that(sieve.divisor_counts() == std::vector<int>{0, 1, 2});
    }
  }
  {
    ...
    {
      const auto divisor_counts = sieve.divisor_counts();
      assert_that(divisor_counts[0] == 0);
      assert_that(divisor_counts[1] == 1);
      assert_that(divisor_counts[2] == 2);
      assert_that(divisor_counts[3] == 2);
      assert_that(divisor_counts[4] == 3);
      assert_that(divisor_counts[5] == 2);
      assert_that(divisor_counts[10000000] == 64);
    }
  }
