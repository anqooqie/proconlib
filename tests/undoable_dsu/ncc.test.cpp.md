...
data:
  ...
  bundledCode: "#line 1 \"tests/undoable_dsu/ncc.test.cpp\"\n#define PROBLEM \"https://atcoder.jp/contests/abc334/tasks/abc334_e\"\
    ...
    \  }\n      }\n    }\n  }\n  answer /= mint::raw(std::accumulate(S.begin(), S.end(),\
    \ 0, [](const auto sum, const auto& S_i) { return sum + std::count(S_i.begin(),\
    \ S_i.end(), '.'); }));\n\n  std::cout << answer.val() << '\\n';\n  return 0;\n\
    }\n"
  code: "#define PROBLEM \"https://atcoder.jp/contests/abc334/tasks/abc334_e\"\n\n\
    ...
    \        }\n\n        answer += mint::raw(dsu.ncc());\n\n        for (int r =\
    \ 0; r < rollback; ++r) {\n          dsu.undo();\n        }\n      }\n    }\n\
    \  }\n  answer /= mint::raw(std::accumulate(S.begin(), S.end(), 0, [](const auto\
    \ sum, const auto& S_i) { return sum + std::count(S_i.begin(), S_i.end(), '.');\
    \ }));\n\n  std::cout << answer.val() << '\\n';\n  return 0;\n}\n"
  dependsOn:
  ...
  verifiedWith: []
documentation_of: tests/undoable_dsu/ncc.test.cpp
layout: document
redirect_from:
- /verify/tests/undoable_dsu/ncc.test.cpp
- /verify/tests/undoable_dsu/ncc.test.cpp.html
