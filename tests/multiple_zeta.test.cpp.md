...
data:
  ...
  bundledCode: "#line 1 \"tests/multiple_zeta.test.cpp\"\n#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/problems/ITP1_1_A\"\
    \n\n#include <iostream>\n#include <vector>\n#include <numeric>\n#include <iterator>\n\
    ...
    \    ::std::move(a.begin(), a.end(), result);\n  }\n}\n\n\n#line 9 \"tests/multiple_zeta.test.cpp\"\
    \n\nint main() {\n  std::cin.tie(nullptr);\n  std::ios_base::sync_with_stdio(false);\n\
    \n  for (int N = 0; N <= 20; ++N) {\n    std::vector<int> a(N);\n    for (int\
    \ i = 0; i < N; ++i) {\n      a[i] = 1 << i;\n    }\n\n    std::vector<int> b(N,\
    \ 0);\n    for (int i = 0; i < N; ++i) {\n      for (int j = 0; j < N; ++j) {\n\
    \        if (std::gcd(i, j) == i) b[i] += a[j];\n      }\n    }\n\n    std::vector<int>\
    \ actual_b;\n    tools::multiple_zeta(a.begin(), a.end(), std::back_inserter(actual_b));\n\
  ...
  verifiedWith: []
documentation_of: tests/multiple_zeta.test.cpp
layout: document
redirect_from:
- /verify/tests/multiple_zeta.test.cpp
- /verify/tests/multiple_zeta.test.cpp.html
