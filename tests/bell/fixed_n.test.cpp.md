...
data:
  ...
  verifiedWith: []
documentation_of: tests/bell/fixed_n.test.cpp
layout: document
redirect_from:
- /verify/tests/bell/fixed_n.test.cpp
- /verify/tests/bell/fixed_n.test.cpp.html
