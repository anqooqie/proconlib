...
data:
  ...
  bundledCode: "#line 1 \"tests/bell/all.test.cpp\"\n#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/problems/DPL_5_G\"\
    ...
    \ K);\n      for (int n = 0; n <= N; ++n) {\n        for (int k = 1; k <= K; ++k)\
    \ {\n          res[n][k] += res[n][k - 1];\n        }\n      }\n\n      return\
    \ res;\n    }\n  }\n}\n\n\n#line 6 \"tests/bell/all.test.cpp\"\n\nusing mint =\
    \ atcoder::modint1000000007;\n\nint main() {\n  std::cin.tie(nullptr);\n  std::ios_base::sync_with_stdio(false);\n\
    \n  int n, k;\n  std::cin >> n >> k;\n  std::cout << tools::bell::all<mint>(n,\
    \ k)[n][k].val() << '\\n';\n\n  return 0;\n}\n"
  ...
  verifiedWith: []
documentation_of: tests/bell/all.test.cpp
layout: document
redirect_from:
- /verify/tests/bell/all.test.cpp
- /verify/tests/bell/all.test.cpp.html
