...
data:
  ...
  bundledCode: "#line 1 \"tests/wavelet_matrix/prev_points.test.cpp\"\n#define PROBLEM\
    \ \"https://onlinejudge.u-aizu.ac.jp/problems/DSL_2_C\"\n\n#include <iostream>\n\
    #include <vector>\n#include <cstddef>\n#include <algorithm>\n#include <iterator>\n\
    ...
    \ + rid);\n    }\n  };\n}\n\n\n#line 9 \"tests/wavelet_matrix/prev_points.test.cpp\"\
  ...
  code: "#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/problems/DSL_2_C\"\n\n\
    ...
    \ partial_answers;\n    for (int y = ty; [&]() {\n      partial_answers = wm.prev_points(sx,\
  ...
  verifiedWith: []
documentation_of: tests/wavelet_matrix/prev_points.test.cpp
layout: document
redirect_from:
- /verify/tests/wavelet_matrix/prev_points.test.cpp
- /verify/tests/wavelet_matrix/prev_points.test.cpp.html
