...
data:
  ...
  bundledCode: "#line 1 \"tests/subset_zeta.test.cpp\"\n#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/problems/ITP1_1_A\"\
    ...
    \    ::std::move(a.begin(), a.end(), result);\n  }\n}\n\n\n#line 8 \"tests/subset_zeta.test.cpp\"\
    \n\nint main() {\n  std::cin.tie(nullptr);\n  std::ios_base::sync_with_stdio(false);\n\
    \n  for (int N = 0; N <= 20; ++N) {\n    std::vector<int> a(N);\n    for (int\
    \ i = 0; i < N; ++i) {\n      a[i] = 1 << i;\n    }\n\n    std::vector<int> b(N,\
    \ 0);\n    for (int i = 0; i < N; ++i) {\n      for (int j = 0; j < N; ++j) {\n\
    \        if ((i | j) == i) b[i] += a[j];\n      }\n    }\n\n    std::vector<int>\
    \ actual_b;\n    tools::subset_zeta(a.begin(), a.end(), std::back_inserter(actual_b));\n\
  ...
  code: "#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/problems/ITP1_1_A\"\n\n\
    ...
    \ {\n      for (int j = 0; j < N; ++j) {\n        if ((i | j) == i) b[i] += a[j];\n\
    \      }\n    }\n\n    std::vector<int> actual_b;\n    tools::subset_zeta(a.begin(),\
    \ a.end(), std::back_inserter(actual_b));\n    assert_that(actual_b == b);\n\n\
    \    tools::subset_zeta(a.begin(), a.end());\n    assert_that(a == b);\n  }\n\n\
    \  std::cout << \"Hello World\" << '\\n';\n  return 0;\n}\n"
  dependsOn:
  ...
  verifiedWith: []
documentation_of: tests/subset_zeta.test.cpp
layout: document
redirect_from:
- /verify/tests/subset_zeta.test.cpp
- /verify/tests/subset_zeta.test.cpp.html
