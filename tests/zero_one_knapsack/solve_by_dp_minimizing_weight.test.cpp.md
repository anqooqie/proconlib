...
data:
  ...
  bundledCode: "#line 1 \"tests/zero_one_knapsack/solve_by_dp_minimizing_weight.test.cpp\"\
...
layout: document
redirect_from:
- /verify/tests/zero_one_knapsack/solve_by_dp_minimizing_weight.test.cpp
- /verify/tests/zero_one_knapsack/solve_by_dp_minimizing_weight.test.cpp.html
