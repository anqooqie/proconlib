...
data:
  ...
  bundledCode: "#line 1 \"tests/fps/inv_mod1000000007.test.cpp\"\n#define PROBLEM\
    ...
    \  solve(tools::fps<mint>({627477697, 504915182, 841612625, 594492394}), tools::fps<mint>({668857537,\
    \ 250555279, 407226641, 689556497}));\n  solve(tools::fps<mint>({729561620, 415335212,\
    \ 437019262, 878914770, 692819383}), tools::fps<mint>({787440026, 114299336, 803189374,\
    \ 407812379, 245736221}));\n  solve(tools::fps<mint>({173330282, 220603612, 817609646,\
    \ 512965573, 521724489, 141011335}), tools::fps<mint>({191023016, 985890395, 527644792,\
    \ 72988565, 170242711, 382839670}));\n  solve(tools::fps<mint>({841413510, 58432763,\
    \ 698722376, 544666771, 190469745, 876171369, 379243778}), tools::fps<mint>({433510165,\
    \ 164122061, 186933015, 588614905, 202135306, 292312010, 956310839}));\n  solve(tools::fps<mint>({251229787,\
  ...
  code: "#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/problems/ITP1_1_A\"\n\n\
    ...
    \ 856000006, 427200003, 712640005}));\n  solve(tools::fps<mint>({192279221}),\
    \ tools::fps<mint>({73800908}));\n  solve(tools::fps<mint>({264704198, 120999146}),\
    \ tools::fps<mint>({287907068, 800104509}));\n  solve(tools::fps<mint>({682152024,\
    \ 451794314, 2028037}), tools::fps<mint>({574612060, 952113573, 8338112}));\n\
    \  solve(tools::fps<mint>({627477697, 504915182, 841612625, 594492394}), tools::fps<mint>({668857537,\
    \ 250555279, 407226641, 689556497}));\n  solve(tools::fps<mint>({729561620, 415335212,\
    \ 437019262, 878914770, 692819383}), tools::fps<mint>({787440026, 114299336, 803189374,\
