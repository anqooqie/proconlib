...
data:
  ...
  bundledCode: "#line 1 \"tests/fps/log_mod1000000007.test.cpp\"\n#define PROBLEM\
    ...
    \ 264704197}, tools::fps<mint>{0, 264704197});\n  solve(tools::fps<mint>{1, 682152023,\
    \ 451794314}, tools::fps<mint>{0, 682152023, 338957876});\n  solve(tools::fps<mint>{1,\
    \ 627477696, 504915182, 841612625}, tools::fps<mint>{0, 627477696, 394229870,\
    \ 361681842});\n  solve(tools::fps<mint>{1, 729561619, 415335212, 437019262, 878914770},\
    \ tools::fps<mint>{0, 729561619, 819295167, 718365157, 380771800});\n  solve(tools::fps<mint>{1,\
    \ 173330281, 220603612, 817609646, 512965573, 521724489}, tools::fps<mint>{0,\
    \ 173330281, 669985986, 616611616, 164659373, 265939606});\n  solve(tools::fps<mint>{1,\
    ...
    \ tools::fps<mint>{0, 251229786, 790492829, 173079494, 244864021, 397382104, 196180830,\
    \ 56137219});\n  solve(tools::fps<mint>{1, 118232767, 222490630, 398642533, 451309769,\
    \ 425956381, 488484142, 913374112, 586809}, tools::fps<mint>{0, 118232767, 175178940,\
    \ 86968890, 301690418, 882749806, 514112978, 213130551, 698601823});\n  solve(tools::fps<mint>{1,\
