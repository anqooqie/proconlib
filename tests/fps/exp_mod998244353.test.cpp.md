...
data:
  ...
  bundledCode: "#line 1 \"tests/fps/exp_mod998244353.test.cpp\"\n#define PROBLEM \"\
    https://judge.yosupo.jp/problem/exp_of_formal_power_series\"\n\n#include <iostream>\n\
    ...
    \    friend F operator>>(const F& f, const int d) { return F(f) >>= d; }\n  };\n\
    }\n\n\n#line 7 \"tests/fps/exp_mod998244353.test.cpp\"\n\nusing ll = long long;\n\
  ...
  verifiedWith: []
documentation_of: tests/fps/exp_mod998244353.test.cpp
layout: document
redirect_from:
- /verify/tests/fps/exp_mod998244353.test.cpp
- /verify/tests/fps/exp_mod998244353.test.cpp.html
