...
data:
  ...
  bundledCode: "#line 1 \"tests/fps/log_other_mods.test.cpp\"\n#define PROBLEM \"\
    https://onlinejudge.u-aizu.ac.jp/problems/ITP1_1_A\"\n\n#include <cstddef>\n#include\
    ...
    \  }\n}\n\n\n#line 13 \"tests/fps/log_other_mods.test.cpp\"\n\ntemplate <typename\
    ...
    \ > lpf(M::mod())) return;\n\n    F expected(a.size());\n    for (std::size_t\
    \ i = 1; i < a.size(); ++i) {\n      expected -= tools::pow<monoid<F>>(monoid<F>::e()\
    ...
    \ 264704197});\n  solve({1, 682152023, 451794314});\n  solve({1, 627477696, 504915182,\
    \ 841612625});\n  solve({1, 729561619, 415335212, 437019262, 878914770});\n  solve({1,\
    \ 173330281, 220603612, 817609646, 512965573, 521724489});\n  solve({1, 841413509,\
    \ 58432763, 698722376, 544666771, 190469745, 876171369});\n  solve({1, 251229786,\
    \ 256388306, 355236246, 511734336, 908168265, 367810644, 342843868});\n  solve({1,\
    \ 118232767, 222490630, 398642533, 451309769, 425956381, 488484142, 913374112,\
    \ 586809});\n  solve({1, 907649120, 290651129, 813718295, 770591820, 913049957,\
    \ 587190944, 411145555, 899491439, 722412549});\n\n  std::cout << \"Hello World\"\
    \ << '\\n';\n  return 0;\n}\n"
...
layout: document
redirect_from:
- /verify/tests/fps/log_other_mods.test.cpp
- /verify/tests/fps/log_other_mods.test.cpp.html
