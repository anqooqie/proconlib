...
data:
  ...
  bundledCode: "#line 1 \"tests/fps/composition.test.cpp\"\n#define PROBLEM \"https://judge.yosupo.jp/problem/composition_of_formal_power_series\"\
    ...
    \ f, const int d) { return F(f) >>= d; }\n  };\n}\n\n\n#line 6 \"tests/fps/composition.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: tests/fps/composition.test.cpp
layout: document
redirect_from:
- /verify/tests/fps/composition.test.cpp
- /verify/tests/fps/composition.test.cpp.html
