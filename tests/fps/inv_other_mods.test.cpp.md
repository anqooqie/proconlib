...
data:
  ...
  bundledCode: "#line 1 \"tests/fps/inv_other_mods.test.cpp\"\n#define PROBLEM \"\
    ...
    \ >>= d; }\n  };\n}\n\n\n#line 10 \"tests/fps/inv_other_mods.test.cpp\"\n\nvoid\
    \ solve(const std::initializer_list<int> il) {\n  const auto specific = [](const\
    ...
    \  solve({682152024, 451794314, 2028037});\n  solve({627477697, 504915182, 841612625,\
    ...
    \  solve({251229787, 256388306, 355236246, 511734336, 908168265, 367810644, 342843868,\
    \ 180913440});\n  solve({118232768, 222490630, 398642533, 451309769, 425956381,\
    \ 488484142, 913374112, 586809, 283205947});\n  solve({907649121, 290651129, 813718295,\
    \ 770591820, 913049957, 587190944, 411145555, 899491439, 722412549, 182227749});\n\
  ...
  verifiedWith: []
documentation_of: tests/fps/inv_other_mods.test.cpp
layout: document
redirect_from:
- /verify/tests/fps/inv_other_mods.test.cpp
- /verify/tests/fps/inv_other_mods.test.cpp.html
