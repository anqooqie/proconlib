...
data:
  ...
  bundledCode: "#line 1 \"tests/cmp_greater_equal.test.cpp\"\n#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/problems/ITP1_1_A\"\
    ...
    \n#line 6 \"tests/cmp_greater_equal.test.cpp\"\n\nint main() {\n  std::cin.tie(nullptr);\n\
    \  std::ios_base::sync_with_stdio(false);\n\n  assert_that(!tools::cmp_greater_equal(-1,\
    \ 0U));\n  assert_that(tools::cmp_greater_equal(0U, 0U));\n  assert_that(tools::cmp_greater_equal(0U,\
    \ -1));\n\n  std::cout << \"Hello World\" << '\\n';\n  return 0;\n}\n"
  code: "#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/problems/ITP1_1_A\"\n\n\
    #include <iostream>\n#include \"tools/assert_that.hpp\"\n#include \"tools/cmp_greater_equal.hpp\"\
    \n\nint main() {\n  std::cin.tie(nullptr);\n  std::ios_base::sync_with_stdio(false);\n\
    \n  assert_that(!tools::cmp_greater_equal(-1, 0U));\n  assert_that(tools::cmp_greater_equal(0U,\
    \ 0U));\n  assert_that(tools::cmp_greater_equal(0U, -1));\n\n  std::cout << \"\
    Hello World\" << '\\n';\n  return 0;\n}\n"
  dependsOn:
  ...
  verifiedWith: []
documentation_of: tests/cmp_greater_equal.test.cpp
layout: document
redirect_from:
- /verify/tests/cmp_greater_equal.test.cpp
- /verify/tests/cmp_greater_equal.test.cpp.html
