...
data:
  ...
  bundledCode: "#line 1 \"tests/triangle_2d/incircle.test.cpp\"\n#define PROBLEM \"\
    https://onlinejudge.u-aizu.ac.jp/problems/CGL_7_B\"\n#define ERROR 1e-6\n\n#include\
    ...
    \n\n\n#line 9 \"tests/triangle_2d/incircle.test.cpp\"\n\nint main() {\n  std::cin.tie(nullptr);\n\
    \  std::ios_base::sync_with_stdio(false);\n\n  std::array<tools::vector2<double>,\
    \ 3> p;\n  std::cin >> p[0] >> p[1] >> p[2];\n  const auto incircle = tools::triangle_2d<double,\
    \ false>(p.begin(), p.end()).incircle();\n  std::cout << std::fixed << std::setprecision(10)\
    \ << incircle.center().x << ' ' << incircle.center().y << ' ' << incircle.radius()\
    \ << '\\n';\n\n  return 0;\n}\n"
  ...
  verifiedWith: []
documentation_of: tests/triangle_2d/incircle.test.cpp
layout: document
redirect_from:
- /verify/tests/triangle_2d/incircle.test.cpp
- /verify/tests/triangle_2d/incircle.test.cpp.html
