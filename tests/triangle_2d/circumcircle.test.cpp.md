...
data:
  ...
  bundledCode: "#line 1 \"tests/triangle_2d/circumcircle.test.cpp\"\n#define PROBLEM\
    \ \"https://onlinejudge.u-aizu.ac.jp/problems/CGL_7_C\"\n#define ERROR 1e-6\n\n\
    #include <iostream>\n#include <array>\n#include <iomanip>\n#include <cmath>\n\
    ...
    \ <optional>\n#line 14 \"tools/detail/geometry_2d.hpp\"\n#include <variant>\n\
    ...
    \ center, const T& radius_or_squared_radius);\n\n    template <bool Filled_ =\
    \ Filled>\n    ::std::enable_if_t<Filled_, F> area() const;\n    ::tools::vector2<T>\
    \ center() const;\n    template <bool HasRadius_ = HasRadius>\n    ::std::enable_if_t<HasRadius_,\
    \ T> radius() const;\n    T squared_radius() const;\n    ::std::pair<int, int>\
    \ where(const ::tools::circle_2d<T, Filled, HasRadius>& other) const;\n    int\
    \ where(const ::tools::vector2<T>& p) const;\n\n    template <typename T_, bool\
    \ Filled_, bool HasRadius1, bool HasRadius2>\n    friend bool operator==(const\
    \ ::tools::circle_2d<T_, Filled_, HasRadius1>& lhs, const ::tools::circle_2d<T_,\
    \ Filled_, HasRadius2>& rhs);\n    template <typename T_, bool Filled_, bool HasRadius1,\
    \ bool HasRadius2>\n    friend bool operator!=(const ::tools::circle_2d<T_, Filled_,\
    \ HasRadius1>& lhs, const ::tools::circle_2d<T_, Filled_, HasRadius2>& rhs);\n\
    \  };\n\n  template <typename T>\n  class directed_line_segment_2d {\n  private:\n\
    ...
    \n\n\n#line 11 \"tests/triangle_2d/circumcircle.test.cpp\"\n\nint main() {\n \
    \ std::cin.tie(nullptr);\n  std::ios_base::sync_with_stdio(false);\n\n  std::array<tools::vector2<tools::rational>,\
    \ 3> p;\n  std::cin >> p[0] >> p[1] >> p[2];\n  const auto circumcircle = tools::triangle_2d<tools::rational,\
    \ false>(p.begin(), p.end()).circumcircle();\n  std::cout << std::fixed << std::setprecision(10)\
    \ << static_cast<double>(circumcircle.center().x) << ' ' << static_cast<double>(circumcircle.center().y)\
    \ << ' ' << std::sqrt(static_cast<double>(circumcircle.squared_radius())) << '\\\
    n';\n\n  return 0;\n}\n"
  code: "#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/problems/CGL_7_C\"\n#define\
    ...
    \ >> p[2];\n  const auto circumcircle = tools::triangle_2d<tools::rational, false>(p.begin(),\
    \ p.end()).circumcircle();\n  std::cout << std::fixed << std::setprecision(10)\
    \ << static_cast<double>(circumcircle.center().x) << ' ' << static_cast<double>(circumcircle.center().y)\
    \ << ' ' << std::sqrt(static_cast<double>(circumcircle.squared_radius())) << '\\\
    n';\n\n  return 0;\n}\n"
...
layout: document
redirect_from:
- /verify/tests/triangle_2d/circumcircle.test.cpp
- /verify/tests/triangle_2d/circumcircle.test.cpp.html
