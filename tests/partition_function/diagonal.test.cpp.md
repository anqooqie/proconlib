...
data:
  ...
  bundledCode: "#line 1 \"tests/partition_function/diagonal.test.cpp\"\n#define PROBLEM\
    \ \"https://judge.yosupo.jp/problem/partition_function\"\n\n#include <iostream>\n\
    ...
    \  std::cout << tools::join(answers.begin(), answers.end(), [](const auto x) {\
    \ return x.val(); }, \" \") << '\\n';\n\n  return 0;\n}\n"
  ...
  verifiedWith: []
documentation_of: tests/partition_function/diagonal.test.cpp
layout: document
redirect_from:
- /verify/tests/partition_function/diagonal.test.cpp
- /verify/tests/partition_function/diagonal.test.cpp.html
