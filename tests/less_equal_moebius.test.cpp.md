...
data:
  ...
  bundledCode: "#line 1 \"tests/less_equal_moebius.test.cpp\"\n#define PROBLEM \"\
    https://onlinejudge.u-aizu.ac.jp/problems/ITP1_1_A\"\n\n#include <iostream>\n\
    ...
    tools/less_equal_moebius.hpp\"\n\n\n\n#line 6 \"tools/less_equal_moebius.hpp\"\
    \n#include <algorithm>\n\nnamespace tools {\n  template <typename RandomAccessIterator>\n\
    \  void less_equal_moebius(const RandomAccessIterator begin, const RandomAccessIterator\
    \ end) {\n    const int N = end - begin;\n    for (int i = N - 1; i - 1 >= 0;\
    \ --i) {\n      begin[i] -= begin[i - 1];\n    }\n  }\n\n  template <typename\
    \ InputIterator, typename OutputIterator>\n  void less_equal_moebius(const InputIterator\
    \ begin, const InputIterator end, const OutputIterator result) {\n    using T\
    \ = typename ::std::iterator_traits<InputIterator>::value_type;\n    ::std::vector<T>\
    \ b(begin, end);\n    ::tools::less_equal_moebius(b.begin(), b.end());\n    ::std::move(b.begin(),\
    \ b.end(), result);\n  }\n}\n\n\n#line 10 \"tests/less_equal_moebius.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: tests/less_equal_moebius.test.cpp
layout: document
redirect_from:
- /verify/tests/less_equal_moebius.test.cpp
- /verify/tests/less_equal_moebius.test.cpp.html
