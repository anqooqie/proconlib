...
data:
  ...
  bundledCode: "#line 1 \"tests/large_fact_mod_cache/fact.test.cpp\"\n#define PROBLEM\
    \ \"https://judge.yosupo.jp/problem/many_factorials\"\n\n#include <iostream>\n\
    ...
    \      return this->binomial(n + r - 1, r);\n    }\n  };\n}\n\n\n#line 6 \"tests/large_fact_mod_cache/fact.test.cpp\"\
...
layout: document
redirect_from:
- /verify/tests/large_fact_mod_cache/fact.test.cpp
- /verify/tests/large_fact_mod_cache/fact.test.cpp.html
