...
data:
  ...
  bundledCode: "#line 1 \"tests/less_by_arg.test.cpp\"\n#define PROBLEM \"https://judge.yosupo.jp/problem/sort_points_by_argument\"\
    ...
    \ const ::std::size_t salt = ::std::random_device()();\n      static const ::std::hash<T1>\
    ...
    \ <typename T>\n  ::std::int_fast64_t ccw(const ::tools::vector2<T>& a, ::tools::vector2<T>\
    ...
    \ ? 0 : 1;\n        } else {\n          if (p.x == 0 && p.y == 0) {\n        \
    \    const int ccw = ::tools::ccw(::tools::vector2<U>(0, 0), this->d, ::tools::vector2<U>(1,\
    \ 0));\n            if (ccw == +1) return 2;\n            if (ccw == +2) return\
    \ 4;\n            if (ccw == -1) return 7;\n            return 9;\n          }\
    \ else {\n            if (this->d == p) return 0;\n            const int ccw =\
    \ ::tools::ccw(::tools::vector2<U>(0, 0), this->d, p);\n            if (ccw ==\
    \ -2) return 0;\n            if (ccw == +1) {\n              const int ccw2 =\
    \ ::tools::ccw(::tools::vector2<U>(0, 0), this->d, ::tools::vector2<U>(1, 0));\n\
    \              if (ccw2 != +1) return 1;\n              const int ccw3 = ::tools::ccw(::tools::vector2<U>(0,\
    \ 0), ::tools::vector2<U>(1, 0), p);\n              if (ccw3 == -1) return 1;\n\
    \              return 3;\n            }\n            if (ccw == +2) return 5;\n\
    \            if (ccw == -1) {\n              const int ccw2 = ::tools::ccw(::tools::vector2<U>(0,\
