...
data:
  ...
  bundledCode: "#line 1 \"tests/range_count_distinct.test.cpp\"\n#define PROBLEM \"\
    https://judge.yosupo.jp/problem/static_range_count_distinct\"\n\n#include <iostream>\n\
    #include <vector>\n#line 1 \"tools/range_count_distinct.hpp\"\n\n\n\n#include\
    \ <cstddef>\n#include <cassert>\n#line 7 \"tools/range_count_distinct.hpp\"\n\
...
layout: document
redirect_from:
- /verify/tests/range_count_distinct.test.cpp
- /verify/tests/range_count_distinct.test.cpp.html
