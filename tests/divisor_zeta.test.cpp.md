...
data:
  ...
  bundledCode: "#line 1 \"tests/divisor_zeta.test.cpp\"\n#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/problems/ITP1_1_A\"\
    \n\n#include <iostream>\n#include <vector>\n#include <numeric>\n#include <iterator>\n\
    ...
    \    ::std::move(a.begin(), a.end(), result);\n  }\n}\n\n\n#line 9 \"tests/divisor_zeta.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: tests/divisor_zeta.test.cpp
layout: document
redirect_from:
- /verify/tests/divisor_zeta.test.cpp
- /verify/tests/divisor_zeta.test.cpp.html
