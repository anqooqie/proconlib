...
data:
  ...
  attributes:
    ...
    PROBLEM: https://atcoder.jp/contests/abc273/tasks/abc273_b
    links:
    - https://atcoder.jp/contests/abc273/tasks/abc273_b
  bundledCode: "#line 1 \"tests/bigdecimal/rounding.test.cpp\"\n#define PROBLEM \"\
    https://atcoder.jp/contests/abc273/tasks/abc273_b\"\n\n#include <iostream>\n#line\
    ...
    \ x;\n  }\n}\n\n\n#line 6 \"tests/bigdecimal/rounding.test.cpp\"\n\nint main()\
    \ {\n  std::cin.tie(nullptr);\n  std::ios_base::sync_with_stdio(false);\n\n  tools::bigdecimal\
    \ X;\n  int K;\n  std::cin >> X >> K;\n\n  for (int k = 0; k < K; ++k) {\n   \
    \ X.divide(tools::bigdecimal(1), -k - 1, tools::rounding_mode::half_up);\n  }\n\
    \n  std::cout << X << '\\n';\n  return 0;\n}\n"
  code: "#define PROBLEM \"https://atcoder.jp/contests/abc273/tasks/abc273_b\"\n\n\
  ...
  verifiedWith: []
documentation_of: tests/bigdecimal/rounding.test.cpp
layout: document
redirect_from:
- /verify/tests/bigdecimal/rounding.test.cpp
- /verify/tests/bigdecimal/rounding.test.cpp.html
