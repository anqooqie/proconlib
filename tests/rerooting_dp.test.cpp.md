...
data:
  ...
  bundledCode: "#line 1 \"tests/rerooting_dp.test.cpp\"\n#define PROBLEM \"https://judge.yosupo.jp/problem/tree_path_composite_sum\"\
    ...
    \n\n\n\n#line 7 \"tools/rerooting_dp.hpp\"\n#include <limits>\n#include <stack>\n\
    #include <tuple>\n#include <algorithm>\n\nnamespace tools {\n  template <typename\
    \ R, typename M, typename F_VE, typename F_EV>\n  class rerooting_dp {\n  private:\n\
    ...
    \      }\n      return result;\n    }\n  };\n}\n\n\n#line 9 \"tests/rerooting_dp.test.cpp\"\
    \n\nusing mint = atcoder::modint998244353;\n\nstruct monoid {\n  using T = std::pair<int,\
    \ mint>;\n  static T op(const T& x, const T& y) {\n    return T(x.first + y.first,\
    ...
    \ {\n    return std::make_pair(sum.first, b[edge_id] * sum.second + c[edge_id]\
    \ * sum.first);\n  };\n  const auto f_ev = [&](const std::pair<int, mint>& sum,\
    \ const std::size_t vertex_id) {\n    return std::make_pair(sum.first + 1, sum.second\
    \ + a[vertex_id]);\n  };\n\n  tools::rerooting_dp<std::pair<int, mint>, monoid,\
    \ decltype(f_ve), decltype(f_ev)> dp(N, f_ve, f_ev);\n  for (int i = 0; i < N\
    \ - 1; ++i) {\n    int u_i, v_i, b_i, c_i;\n    std::cin >> u_i >> v_i >> b_i\
  ...
  requiredBy: []
  timestamp: '2023-05-13 15:37:06+09:00'
