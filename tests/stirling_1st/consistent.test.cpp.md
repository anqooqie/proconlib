...
data:
  ...
  bundledCode: "#line 1 \"tests/stirling_1st/consistent.test.cpp\"\n#define PROBLEM\
    \ \"https://onlinejudge.u-aizu.ac.jp/problems/ITP1_1_A\"\n\n#include <iostream>\n\
    ...
    \ ::tools::virtual_vector(K + 1, [N, s](const int k) -> const M& {\n        static\
    \ const auto zero = M::raw(0);\n        return k <= N ? s.pbegin()[k] : zero;\n\
    \      });\n    }\n\n    template <typename M>\n    auto fixed_k(const int N,\
    \ const int K) {\n      assert(::tools::is_prime(M::mod()));\n      assert(0 <=\
    ...
    \        for (int i = 0; i <= N - K; ++i) {\n          f[i] = cache.inv(i + 1);\n\
    \        }\n        f.pow_inplace(K);\n        f *= cache.fact_inv(K);\n     \
    \   for (int n = K; n <= N; ++n) {\n          f[n - K] *= cache.fact(n) * pow_m1[n\
    \ + K];\n        }\n      }\n\n      return ::tools::virtual_vector(N + 1, [K,\
    \ f](const int n) -> const M& {\n        static const auto zero = M::raw(0);\n\
    ...
    \ += s[n - 1][k - 1];\n          s[n][k] -= M(n - 1) * s[n - 1][k];\n        }\n\
    \      }\n      return s;\n    }\n  }\n}\n\n\n#line 7 \"tests/stirling_1st/consistent.test.cpp\"\
    \n\nusing mint = atcoder::modint998244353;\n\nint main() {\n  std::cin.tie(nullptr);\n\
    \  std::ios_base::sync_with_stdio(false);\n\n  for (int N = 0; N < 50; ++N) {\n\
    \    for (int K = 0; K < 50; ++K) {\n      const auto all = tools::stirling_1st::all<mint>(N,\
    \ K);\n\n      for (int n = 0; n <= N; ++n) {\n        const auto fixed_n = tools::stirling_1st::fixed_n<mint>(n,\
    \ K);\n        for (int k = 0; k <= K; ++k) {\n          assert_that(all[n][k]\
    \ == fixed_n[k]);\n        }\n      }\n\n      for (int k = 0; k <= K; ++k) {\n\
  ...
  verifiedWith: []
documentation_of: tests/stirling_1st/consistent.test.cpp
layout: document
redirect_from:
- /verify/tests/stirling_1st/consistent.test.cpp
- /verify/tests/stirling_1st/consistent.test.cpp.html
