...
data:
  ...
  bundledCode: "#line 1 \"tests/stirling_1st/fixed_n.test.cpp\"\n#define PROBLEM \"\
    https://judge.yosupo.jp/problem/stirling_number_of_the_first_kind\"\n\n#include\
    ...
    \  }\n}\n\n\n#line 7 \"tests/stirling_1st/fixed_n.test.cpp\"\n\nusing mint = atcoder::modint998244353;\n\
    \nint main() {\n  std::cin.tie(nullptr);\n  std::ios_base::sync_with_stdio(false);\n\
    \n  int N;\n  std::cin >> N;\n\n  const auto answers = tools::stirling_1st::fixed_n<mint>(N,\
    \ N);\n  std::cout << tools::join(answers.begin(), answers.end(), [](const auto\
    \ x) { return x.val(); }, \" \") << '\\n';\n\n  return 0;\n}\n"
  ...
  verifiedWith: []
documentation_of: tests/stirling_1st/fixed_n.test.cpp
layout: document
redirect_from:
- /verify/tests/stirling_1st/fixed_n.test.cpp
- /verify/tests/stirling_1st/fixed_n.test.cpp.html
