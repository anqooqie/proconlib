...
data:
  ...
  bundledCode: "#line 1 \"tests/stirling_2nd/fixed_k.test.cpp\"\n#define PROBLEM \"\
    https://judge.yosupo.jp/problem/stirling_number_of_the_second_kind_fixed_k\"\n\
    ...
    \  }\n}\n\n\n#line 7 \"tests/stirling_2nd/fixed_k.test.cpp\"\n\nusing mint = atcoder::modint998244353;\n\
    \nint main() {\n  std::cin.tie(nullptr);\n  std::ios_base::sync_with_stdio(false);\n\
    \n  int N, K;\n  std::cin >> N >> K;\n\n  const auto answer = tools::stirling_2nd::fixed_k<mint>(N,\
...
layout: document
redirect_from:
- /verify/tests/stirling_2nd/fixed_k.test.cpp
- /verify/tests/stirling_2nd/fixed_k.test.cpp.html
