...
data:
  ...
  bundledCode: "#line 1 \"tests/stirling_2nd/consistent.test.cpp\"\n#define PROBLEM\
    \ \"https://onlinejudge.u-aizu.ac.jp/problems/ITP1_1_A\"\n\n#include <iostream>\n\
    ...
    \    for (int K = 0; K < 50; ++K) {\n      const auto all = tools::stirling_2nd::all<mint>(N,\
    \ K);\n\n      for (int n = 0; n <= N; ++n) {\n        const auto fixed_n = tools::stirling_2nd::fixed_n<mint>(n,\
    \ K);\n        for (int k = 0; k <= K; ++k) {\n          assert_that(all[n][k]\
    \ == fixed_n[k]);\n        }\n      }\n\n      for (int k = 0; k <= K; ++k) {\n\
  ...
  verifiedWith: []
documentation_of: tests/stirling_2nd/consistent.test.cpp
layout: document
redirect_from:
- /verify/tests/stirling_2nd/consistent.test.cpp
- /verify/tests/stirling_2nd/consistent.test.cpp.html
