...
data:
  ...
  bundledCode: "#line 1 \"tests/less_equal_zeta.test.cpp\"\n#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/problems/ITP1_1_A\"\
    \n\n#include <iostream>\n#include <random>\n#include <vector>\n#include <iterator>\n\
    ...
    tools/less_equal_zeta.hpp\"\n\n\n\n#line 6 \"tools/less_equal_zeta.hpp\"\n#include\
    \ <algorithm>\n\nnamespace tools {\n  template <typename RandomAccessIterator>\n\
    \  void less_equal_zeta(const RandomAccessIterator begin, const RandomAccessIterator\
    \ end) {\n    const int N = end - begin;\n    for (int i = 1; i < N; ++i) {\n\
    \      begin[i] += begin[i - 1];\n    }\n  }\n\n  template <typename InputIterator,\
    \ typename OutputIterator>\n  void less_equal_zeta(const InputIterator begin,\
    \ const InputIterator end, const OutputIterator result) {\n    using T = typename\
    \ ::std::iterator_traits<InputIterator>::value_type;\n    ::std::vector<T> a(begin,\
    \ end);\n    ::tools::less_equal_zeta(a.begin(), a.end());\n    ::std::move(a.begin(),\
    \ a.end(), result);\n  }\n}\n\n\n#line 10 \"tests/less_equal_zeta.test.cpp\"\n\
    ...
    \ b(N, mint::raw(0));\n    for (int i = 0; i < N; ++i) {\n      for (int j = 0;\
    \ j < N; ++j) {\n        if (j <= i) b[i] += a[j];\n      }\n    }\n\n    std::vector<mint>\
    \ actual_b;\n    tools::less_equal_zeta(a.begin(), a.end(), std::back_inserter(actual_b));\n\
  ...
  verifiedWith: []
documentation_of: tests/less_equal_zeta.test.cpp
layout: document
redirect_from:
- /verify/tests/less_equal_zeta.test.cpp
- /verify/tests/less_equal_zeta.test.cpp.html
