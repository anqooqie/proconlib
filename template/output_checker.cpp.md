...
data:
  ...
  bundledCode: "#line 1 \"tools/util.hpp\"\n\n\n\n#ifdef LOCAL\n  #ifndef _GLIBCXX_DEBUG\n\
    ...
    \ ::std::ostream&> {\n  return os << x.val();\n}\n\n\n#line 2 \"template/output_checker.cpp\"\
    \n\nint main(const int argc, char *argv[]) {\n  const std::string input = argc\
  ...
  code: "#include \"tools/util.hpp\"\n\nint main(const int argc, char *argv[]) {\n\
    \  const std::string input = argc > 1 ? argv[1] : \"\";\n  const std::string your_output\
    \ = argc > 2 ? argv[2] : \"\";\n  const std::string expected_output = argc > 3\
    \ ? argv[3] : \"\";\n\n  {\n    std::ifstream ifs(input);\n  }\n  {\n    std::ifstream\
    \ ifs(your_output);\n  }\n  {\n    std::ifstream ifs(expected_output);\n  }\n\n\
    \  return 0;\n}\n"
  dependsOn:
  ...
  verifiedWith: []
documentation_of: template/output_checker.cpp
layout: document
redirect_from:
- /library/template/output_checker.cpp
- /library/template/output_checker.cpp.html
